...
public class QuestionVO {
   ...
   public QuestionVO(int q_no, String writer, String title, String content, String cate1, String cate2, String cate3,
         int count, Date reg_date, Date update_date) {
      super();
      this.q_no = q_no;
      this.writer = writer;
      this.title = title;
   ...
   public QuestionVO(int q_no, String writer, String title, String content, String cate1, String cate2, String cate3,
		int count, Date reg_date, Date update_date, int answerCount) {
	super();
	this.q_no = q_no;
	this.writer = writer;
	this.title = title;
...
public QuestionVO(int q_no, String writer, String title, String content, String cate1, String cate2, String cate3,
		int count, Date reg_date, Date update_date, int answerCount, int replyCount) {
	super();
	this.q_no = q_no;
	this.writer = writer;
	this.title = title;
